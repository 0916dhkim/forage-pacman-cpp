...
Clyde::Clyde(const std::shared_ptr<QGraphicsScene> &sc,
...
void Clyde::ft_find_path() {
  ...
  map_path[inky.lock()->ft_get_i_pos()][inky.lock()->ft_get_j_pos()] = -5;
  ...
  map_path[inky.lock()->ft_get_i_pos()][inky.lock()->ft_get_j_pos()] = 0;
}
...
void Clyde::ft_set_friends(const std::shared_ptr<Blinky> &bl,
